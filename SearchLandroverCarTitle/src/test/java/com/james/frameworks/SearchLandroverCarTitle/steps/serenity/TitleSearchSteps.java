package com.james.frameworks.SearchLandroverCarTitle.steps.serenity;
...
import com.james.frameworks.SearchLandroverCarTitle.pages.HomePage;
import com.james.frameworks.SearchLandroverCarTitle.pages.SearchResultsPage;

import net.thucydides.core.annotations.Step;

public class TitleSearchSteps {

    HomePage homePage;                                          
    SearchResultsPage searchResultsPage;

    @Step                                                       
    public void opens_landrover_home_page() {
        homePage.open();
    }
